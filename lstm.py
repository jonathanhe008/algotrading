...
if __name__ == "__main__":
    ...
    train_size = int(mid_prices.size*0.8)
    ...
    smoothing_window_size = int(0.25*train_size)
    data_range = int(0.5*mid_prices.size)
    for di in range(0,data_range,smoothing_window_size):
    ...
    test_points_seq = np.arange(train_size,train_size+1000,50).tolist() 
    ...
    best_prediction_epoch = 19 # replace this with the epoch that you got the best results when running the plotting code
    ...
    plt.xlabel('Date',fontsize=18)
    plt.ylabel('Mid Price',fontsize=18)
    plt.xlim(train_size,train_size+1000)
